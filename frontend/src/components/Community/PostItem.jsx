...
const PostItem = ({ post, user, handleDeletePost }) => {
  return (
    <div className="p-6 rounded-3xl backdrop-blur-xl bg-white/10 shadow-lg border border-white/20 transform transition-all hover:scale-[1.01] duration-300">
      {/* ⭐️ Top-level container for user info and delete button */}
      <div className="flex justify-between items-start space-x-4 mb-3">
        ...
        {/* ⭐️ Conditional Delete Button aligned to the right */}
