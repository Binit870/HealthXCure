...
const UserProfileSection = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center mb-12">
      ...
      >
        {profileImageUrl ? (
          <img
            ...
            src={profileImageUrl}
            alt="User Profile"
            className="w-full h-full rounded-full object-cover border-4 border-gray-800 transition-transform duration-300 group-hover:scale-105"
          />
        ) : (
      ...
      {uploading && <p className="text-sm text-blue-400 mt-3 animate-pulse">Uploading...</p>}
