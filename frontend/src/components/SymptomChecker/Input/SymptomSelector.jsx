...
const symptomOptions = [
    ...
    "Constipation",
    "Heartburn",
    // The following were conditions/specific issues and are removed from the options list below:
    // "Palpitations", "High Blood Pressure", "Low Blood Pressure", "Anxiety", "Depression",
    // "Insomnia", "Allergies", "Asthma", "Diabetes", "Hypertension", "Urinary Tract Infection (UTI)",
    // "Flu (Influenza)", "Migraine", "Cold Sores", "Ear Pain", "Eye Irritation", "Skin Infection",
    // "Food Poisoning", "Hypothyroidism", "Hyperthyroidism",
];
