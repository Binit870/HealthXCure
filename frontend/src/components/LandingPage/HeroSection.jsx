...
const HeroSection = () => (
  ...
  >
    ...
    <div className="relative z-10 text-center px-6">
      ...
      <h3 className="text-xl md:text-2xl text-white font-semibold mb-4 animate-fade-in-delay">
        Trusted care, anytime, anywhere.
      </h3>
      <p className="text-lg md:text-xl text-white max-w-3xl mx-auto mb-4 animate-fade-in-delay">
